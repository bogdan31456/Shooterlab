...
public class CameraHandler : MonoBehaviour
{
    ...
    public float smothXVelocity;
    public float smothYVelocity;
    ...
    void HandleRotation()
    {
        ...
        {
            smoothX=Mathf.SmoothDamp(smoothX,mouseX,ref smothXVelocity,cameraConfig.turnSmooth);
            smoothY=Mathf.SmoothDamp(smoothY,mouseY,ref smothYVelocity,cameraConfig.turnSmooth);
        }
        else
        {
            smoothX = mouseX;
